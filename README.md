...
| 06 | [AI-Ops e Engenharia Agêntica](#06--ai-ops-e-engenharia-agêntica) | 3 projetos |
...
| # | Projeto | O que demonstra |
|---|---------|----------------|
| 001 | [Da Automação à Inteligência Agêntica](disciplinas/06-aiops-engenharia-agentica/projects/001-da-automacao-a-inteligencia-agentica/README.md) | Primeiro agente CrewAI da trilha (Arquiteto de Cloud, rodando sobre Groq `openai/gpt-oss-20b`) que consulta uma tool de políticas de compliance antes de desenhar um bucket S3 — passagem de IA generativa solta para IA consultiva |
