...
### PASSOS QUE NÃO ESTAO NO SLIDE:

#### TRABALHANDO COM DEPLOY:
...
```
**NESSE MOMENTO TEMOS APENAS 2 ARQUIVOS NA PASTA `k8s`: `deploy.yaml` e `secrets.yaml`**

#### ENCAPSULANDO EM UM JOB:
